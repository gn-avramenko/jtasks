...
import com.gridnine.jtasks.common.core.model.rest.CreateProjectRequestJS
import com.gridnine.jtasks.common.core.model.rest.CreateUserAccountRequestJS
import com.gridnine.jtasks.common.core.model.ui.NewProjectEditor
        ...
        WebUiLibraryAdapter.get().showDialog(editor){
            ...
            button {
                ...
                handler = {
                    ...
                    val response = JtasksRestClient.jtasks_project_create(CreateProjectRequestJS().also { resp ->
                        resp.vm = vm
                    })
